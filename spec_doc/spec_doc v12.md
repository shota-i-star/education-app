...
**用途：** 各カテゴリをどの部署に紐づけるかを管理する中間テーブル
...
| 鈴木 部長 | 00001 | suzuki1234 | manager_admin | － | 東京エリア |
...
### 項目追加モーダル
- 項目追加と同時にステップを複数登録できる
- Enterキーまたは「＋ 追加」ボタンでステップをリストに積み上げ
- 「追加する」で項目とステップを一括保存する
